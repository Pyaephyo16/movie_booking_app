...
class MovieChooseTimePage extends StatelessWidget {
                ...
                Builder(
                  builder: (context) => MovieChooseDateView(
                    selectedDate: (String? date) {
                      print(
                          "date data check ==========> ${date?.split(" ")[0]}");
                      print(
                          "date data compare =======> ${DateTime.now().toString().split(" ")[0]}");
                      //getNewTimeslots(date.toString().split(" ")[0]);
                      getDate = date;
                      MovieChooseTimePageBloc _chooseTimeBloc =
  ...
  _navigateToNextScreen(
    ...
    if (userChooseTime != "" &&
      ...
      return Navigator.push(
        context,
        MaterialPageRoute(
            builder: (BuildContext context) => MovieSeatsPage(
  ...
  onTapAction(
      List<CinemaVO> cinema, int cindex, int index, BuildContext context) {
      ...
      child: Column(
        children: [
          DatePicker(
            ...
            selectionColor: THEME_COLOR[EnvironmentConfig.CONFIG_THEME_COLOR],
...
class TimeslotSectionView extends StatelessWidget {
  ...
  TimeslotSectionView(
      {required this.cinema, required this.cindex, required this.onTapAction});
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: cinema[cindex].timeslots?[index].isSelected == true
                    ...
                    child: Center(
                        child: Text(
                      cinema[cindex].timeslots?[index].startTime ?? "",
                      style: TextStyle(
                        color:
                            cinema[cindex].timeslots?[index].isSelected == true
                                ? Colors.white
                                : Colors.black,
                      ),
                    )),
